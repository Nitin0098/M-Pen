...
5. Fixed SystemCoreClock multiply defined — excluded duplicate
...
9. Fixed AUTO_SR comment — it fires every measurement, not every 100
10. Removed AUTO_SR from trigger entirely, replaced with periodic manual SET every 10 s
11. Bug fix: MMC5603_LSB_PER_UT was 102.4 (10× wrong) → corrected to 10.24
...
4. Fixed ink style — removed variable-width pooling effects, plain 3px dark blue line
5. Fixed A4 dimensions — was 30×21 cm, corrected to 29.7×21 cm landscape
